...
import {mapMutations, mapState} from "vuex"
    ...
    export default {
        ...
        watch:{
            visible(){
                // this.ruleForm=this.row  这种方法会在ruleForm加入一些用不到的数据，但不影响使用
                const{name,start,end,cargo,count,unit,price,from,pay}=this.row//解构写法
